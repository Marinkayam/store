...
check("activation screen lists what she gets", act.includes("חנות אמיתית באינטרנט") && act.includes("לינק פרטי לשיתוף"));
check("activation screen shows the payback math", act.includes("היא מחזירה את זה") && act.includes("סקווישים"));
