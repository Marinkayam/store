...
הילדה מצלמת מוצר ולוחצת "כתבי לי תיאור" — Claude רואה את התמונה וכותב תיאור קצר בעברית, שהיא יכולה לערוך. **דלוק לכל החנויות** (מיגרציה 0011).

זה נבנה תחילה כפרימיום ונפתח לכולן: תיאור עולה ~0.6 אגורות, חנות מלאה ~12 אגורות. הסף נמוך מכדי להצדיק גדר, והפיצ'ר עוזר בדיוק במקום שילדה בת עשר נתקעת — היא יודעת לצלם, היא לא יודעת לנסח. הקרדיטים נשארו כתקרה נגד שימוש לרעה (50 לחנות), לא כמכסת מכירה, והמנהלת יכולה לכבות לחנות בעייתית.

- הפעלה: `ANTHROPIC_API_KEY` ב-env, **ובנוסף** הדלקה פר חנות מהחמ"ל.
  בלי המפתח כפתור ההדלקה בחמ"ל מושבת ומוצגת אזהרה — אחרת היה אפשר להדליק
  פרימיום לחנות והילדה הייתה מקבלת שגיאה בלחיצה.
