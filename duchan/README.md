...
`e2e-activation.mjs` — **31 בדיקות** של מסלול התשלום והרשת: הלינק נעול בטיוטה · ההזמנות
...
והלינק נפתח מיד · מסך "להפיץ" · חברה מגיעה מהחנות, פותחת חנות, והשיוך מופיע באשכול.
