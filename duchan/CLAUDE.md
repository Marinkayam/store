...
| מדיה לחנות | 50MB (ברירת מחדל; הגדלה פר-חנות מהחמ"ל) |
| חנויות למספר טלפון | 3 |

**בכוונה בלי תקרה:** מוצרים לחנות, הזמנות ליום. הוסרו לבקשת מרינה —
אם מגבלת קצב הזמנות תידרש שוב בעתיד (למשל הצפה אמיתית), זו החלטת מוצר
מחדש, לא ברירת מחדל.
