  ...
  return (
    <main className="min-h-screen bg-white">
      <div className="max-w-md mx-auto px-5 py-10 text-[15px] leading-7 text-[var(--ink)]">
        ...
        <Section title="מה אנחנו לא אוספים — בכוונה">
        ...
        <Section title="היכן המידע נשמר">
          ...
          הגישה למידע מוגבלת טכנית כך שכל בעלת חנות רואה אך ורק את הנתונים של
          החנות שלה.
        </Section>
        ...
        <Section title="מחיקה ושחזור">
          ...
          חנות לבקשת בעלת החנות או הורה מוחקת את פרטי החשבון והחנות. גיבויים
